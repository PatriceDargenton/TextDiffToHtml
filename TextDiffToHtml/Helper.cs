...
namespace TextDiffToHtml
{
    internal class Helper
    {
        ...
        public static StringBuilder GetSideBySideStyle(StringBuilder sb,
            bool colorizeDiff, bool monospacedFont, bool showSimilarity = false)
        {
            ...
            if (showSimilarity)
                sb.AppendLine("    <tr><th>L</th><th>Left</th><th>Delta</th><th>Right</th><th>R</th><th>Similarity</th></tr>");
            else
    ...
    <thead><tr><th class='rb'>L</th><th class='rb'>R</th><th>D</th><th>Line</th></tr></thead><tbody>");
        ...
        public static string BuildMinimalHtmlDocument(string bodyHtml, string lang = "fr")
        {
